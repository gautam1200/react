...
function Resultstate() {
    const [demo , setname] = useState([
        {name:"gautam", s1:66 , s2:89 , s3:65},
        {name:"sumit", s1:81 , s2:64 , s3:78},
        {name:"ankit", s1:85 , s2:78 , s3:56},
        {name:"mohit", s1:65 , s2:95 , s3:84},
        {name:"raj", s1:68 , s2:56 , s3:65}
    ])
    function total(item){
